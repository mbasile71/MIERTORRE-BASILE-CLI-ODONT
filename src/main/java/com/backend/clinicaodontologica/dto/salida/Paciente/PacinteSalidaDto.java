...
public class PacinteSalidaDto {
    ...
    public PacinteSalidaDto() {
    }

    public PacinteSalidaDto(int id, String nombre, String apellido, int dni, LocalDate fechaIngreso, DomicilioSalidaDto domicilioSalidaDto) {
        this.id = id;
        this.nombre = nombre;
